...
BS_18S <- na.omit(select(big_seq, "Sample", "18S", "Zooxanthellate"))
...
crust_mode_shuffled <- c(1:length(BS_18S_names))
for(i in 1:length(BS_18S_names)){
...
plotTree(BS18Sl_tree,type="phylogram",fsize=0.8,ftype="i",lwd=2)
...
fixed_tree <- root(BS18Sl_tree, outgroup = "Parazoanthus sp. New Caledonia Shallow")
