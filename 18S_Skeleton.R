...
BS_18S <- na.omit(select(big_seq, "Sample", "18S", "Skeleton"))
...
BS_18S_names_shuffled <- c(1:length(BS_18S_names))
...
Skeleton_mode <- Skeleton_mode_og[!is.na(Skeleton_mode_og$"18S"),]
#crust_mode
...
cbind(Skeleton_mode_shuffled, BS_18S_names_shuffled)
