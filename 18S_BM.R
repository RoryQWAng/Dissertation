...
BS_18S <- na.omit(select(big_seq, "Sample", "18S", "Macrocnemic.Brachycnemic"))
BS_18S <- BS_18S %>% filter(Macrocnemic.Brachycnemic != "Unknown")
BS_18S <- BS_18S %>% filter(Macrocnemic.Brachycnemic != "Unkown")
...
cbind(BM_mode_shuffled, BS_18S_names_shuffled)
