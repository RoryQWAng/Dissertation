...
BS_COI <- na.omit(select(big_seq, "Sample", "COI", "Zooxanthellate"))
...
plotTree(BSCOIl_tree,type="phylogram",fsize=0.8,ftype="i",lwd=2)
...
fixed_tree <- root(BSCOIl_tree, outgroup = "Palythoa tuberculosa")
