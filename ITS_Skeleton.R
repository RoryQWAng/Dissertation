...
BS_ITS <- na.omit(select(big_seq, "Sample", "ITS", "Skeleton"))
...
Skeleton_mode <- Skeleton_mode_og[!is.na(Skeleton_mode_og$"ITS"),]
#crust_mode
...
cbind(Skeleton_mode_shuffled, BS_ITS_names_shuffled)
