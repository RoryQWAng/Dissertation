...
BS_16S <- na.omit(select(big_seq, "Sample", "16S", "Substrate"))
...
substrate_mode <- substrate_mode_og[!is.na(substrate_mode_og$"16S"),]
#crust_mode
...
cbind(substrate_mode_shuffled, BS_16S_names_shuffled)
